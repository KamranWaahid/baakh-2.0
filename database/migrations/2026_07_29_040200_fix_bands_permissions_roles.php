...
return new class extends Migration
{
    public function up(): void
    {
        ...
        // Matches production role names (Admins / super_admin), plus seed role variants.
        ...
        foreach (['Contributor', 'contributor'] as $roleName) {
            if ($role = Role::where('name', $roleName)->first()) {
                $role->givePermissionTo([
                    'view_bands',
                    'create_bands',
    ...
    {
        // Keep permissions; only reverse role grants if needed elsewhere.
        app()[\Spatie\Permission\PermissionRegistrar::class]->forgetCachedPermissions();
    }
};
