...
Route::prefix('v1')->group(function () {
    ...
    Route::middleware('throttle:12,1')->get('auth/google/redirect', [LoginWithGoogleController::class, 'loginWithGoogle']);
...
Route::middleware(['auth:sanctum', 'user_role'])->prefix('admin')->group(function () {
    ...
    // Dictionary Sync (Import is still protected by auth)
...
Route::prefix('admin/databases/dictionary')->group(function () {
