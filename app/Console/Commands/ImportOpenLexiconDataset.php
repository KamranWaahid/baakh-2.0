...
class ImportOpenLexiconDataset extends Command
{
    ...
    private function prepareRow(array $row): ?array
    {
        ...
        return [
            ...
            'short_gloss' => $this->nullableString($row['short_gloss'] ?? null, self::INDEXED_TEXT_LIMIT),
            'full_definition' => $this->nullableString($row['full_definition'] ?? null),
            ...
            'publisher' => $this->nullableString($row['publisher'] ?? null, self::INDEXED_TEXT_LIMIT),
            'license' => $this->nullableString($row['license'] ?? null, self::INDEXED_TEXT_LIMIT),
            'import_version' => $this->nullableString($row['import_version'] ?? 'open_lexicon_master_223k', self::INDEXED_TEXT_LIMIT),
