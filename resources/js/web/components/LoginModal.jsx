        ...
        <Dialog>
            ...
            <DialogContent className="sm:max-w-md bg-white p-12 shadow-xl border-0">
                ...
                <div className="flex flex-col gap-3">
                    <Button variant="outline" className="rounded-full h-12 border-black/10 hover:border-black hover:bg-transparent justify-start px-4 relative font-normal text-base">
