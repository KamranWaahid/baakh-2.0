        ...
        return (
            <Card>
                <CardHeader>
                    ...
                    <CardDescription>Could not load today’s incomplete general-dictionary word.</CardDescription>
                </CardHeader>
                <CardContent>
                    ...
                    <div className="flex items-start justify-between gap-3 flex-wrap">
                        <div className="min-w-0">
                            ...
                            <CardDescription className="mt-1">
                                All general-dictionary words are complete.
                            </CardDescription>
                        </div>
                        {statusBadge}
                    </div>
            ...
            <CardHeader className="pb-4">
                <div className="flex flex-col lg:flex-row lg:items-start justify-between gap-4">
                    <div className="min-w-0">
                        ...
                        <CardDescription className="mt-1">
                            Review and complete one incomplete general-dictionary entry. It stays for today until finished or skipped.
                        </CardDescription>
                    </div>
