        ...
        <div class="col-9 m-auto">
            <div class="card">
                <form action="{{ route('role.permission.store') }}" method="post">
                    @csrf
                    <div class="card-body">
                        <select name="role_id" id="role_id" class="select2 w-100">
                            ...
                            <div class="row ml-2">
                                <div class="col-3 groups">
                                    <div class="form-group">
                                        <input type="checkbox" class="form-check-select prms prms-grp" id="group_{{ $group->group_name }}">
                                ...
                                <div class="col-9 permissions">
                                    ...
                                    @foreach ($permissions as $permission)
                                        <div class="sgroup">
                                            <input type="checkbox" class="form-check-select prms group_{{ $group->group_name }}" name="permission[]" value="{{ $permission->id }}" id="permission_{{ $permission->id }}">
