...
@section('title', 'Add Doodle')

@section('content_header')
    <h1 class="m-0 text-dark">Doodle</h1>
@endsection
                    ...
                    <div class="card-body">
                            ...
                            <div class="row" id="row2">
                                ...
                                <div class="form-group col-6">
                                    ...
                                    <input type="date" name="start_date" class="form-control input-start_date @error('start_date') is-invalid @enderror" value="{{ old('start_date') }}"  placeholder="Insert Start Date">
                                ...
                                <div class="form-group col-6">
                                    ...
                                    <input type="date" name="end_date" class="form-control input-end_date @error('end_date') is-invalid @enderror" value="{{ old('end_date') }}"  placeholder="Insert End Date">
                                    ...
                                    <label for="poet_id">Poets</label>
                                        <select name="poet_id" id="poet_id" class="form-control select2 @error('poet_id') is-invalid @enderror">
                                            ...
                                            @foreach ($poets as $item)
                                                <option value="{{ $item->id }}">{{ $item->poet_laqab }}</option>
                                            @endforeach
                                        </select>
