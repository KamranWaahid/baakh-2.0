        ...
        <div class="card">
            <div class="card-body">
                ...
                <form action="{{ route('admin.tags.store') }}" method="post">
                    ...
                    @foreach ($languages as $k => $lang)
                        <div class="dynamic_data row">
                            <div class="form-group col-10">
                                ...
                                <input type="text" name="tag[]" value="{{ old('tag')[$k] ?? '' }}" class="form-control"
                                    autocomplete="off">
                                @error('tag')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                            ...
                            <div class="form-group col-2">
                                ...
                                <input type="text" disabled id="lang_title{{ $lang->lang_code }}" class="form-control"
                                    value="{{ $lang->lang_title }}">
                                <input type="hidden" name="lang[]" id="lang_{{ $lang->lang_code }}"
                    ...
                    <div class="col-12">
                        <button type="submit" class="btn btn-block btn-primary" name="submit"><i
