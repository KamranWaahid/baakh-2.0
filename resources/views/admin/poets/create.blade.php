...
@section('content')
    <div class="row">
        <div class="col-12">
            <div class="card">
                <form action="{{ route('admin.poets.store') }}" method="post" id="addPoetForm"
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-6">
                                ...
                                <input type="text" class="form-control  @error('poet_slug') is-invalid @enderror"
                                    value="{{ old('poet_slug') }}" name="poet_slug" id="poet_slug"
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-4">
                                ...
                                <input type="date" class="form-control  @error('date_of_death') is-invalid @enderror"
                                    value="{{ old('date_of_death') }}" name="date_of_death" id="date_of_death">
