                    ...
                    <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-6">
                                    ...
                                    <input type="text" class="form-control  @error('poet_slug') is-invalid @enderror" value="{{ old('poet_slug', $poet->poet_slug) }}"  name="poet_slug" id="poet_slug" placeholder="Enter Poet's Slug or name without space">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-4">
                                    ...
                                    <input type="date" class="form-control  @error('date_of_birth') is-invalid @enderror" value="{{ old('date_of_birth', $poet->date_of_birth) }}"  name="date_of_birth" id="date_of_birth">
                                ...
                                <div class="form-group col-4">
                                    ...
                                    <input type="date" class="form-control  @error('date_of_death') is-invalid @enderror" value="{{ old('date_of_death', $poet->date_of_death) }}"  name="date_of_death" id="date_of_death">
                                ...
                                <div class="form-group col-4">
                                    <a href="{{ asset($poet->poet_pic); }}" class="float-right" target="_blank">See Current Picture</a>
