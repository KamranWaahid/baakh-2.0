      ...
      <div class="card">
        <div class="card-header">
          ...
          <div class="float-right">
            <a href="{{ route('admin.couplets.trash') }}" class="btn btn-sm btn-warning float-right mr-1"><i
                class="fa fa-trash"></i> View Trashed</a>
            <a href="{{ route('admin.couplets.create') }}" class="btn btn-sm btn-success mr-1"><i
                class="fa fa-plus mr-1"></i> New Couplets</a>
          </div>
        </div>
        <div class="card-body">
